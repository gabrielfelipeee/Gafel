...
public class GetCategoryByIdUseCaseTest
{
    ...
    private static GetCategoryByIdUseCase CreateUseCase(UserDto user, Gafel.Domain.Entities.Category? category = null, Gafel.Domain.Entities.Person? person = null)
    {
        ...
        if (person is not null && category is not null)
            categoryReadOnlyRepository.GetById(person, category);
